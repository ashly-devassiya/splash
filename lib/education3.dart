import 'package:splash/menu.dart';
import 'package:splash/start_up.dart';
        ...
        children: [
          ...
          if (_isMenuOpen)
            Positioned(
              ...
              top: 0,
              width: MediaQuery.of(context).size.width *
                  0.75, // Adjust width to 75% of screen width
              height: MediaQuery.of(context).size.height,
              child: Menu(
                isOpen: _isMenuOpen,
                onClose: _toggleMenu,
...
class StartupPageContent extends StatelessWidget {
  ...
  const StartupPageContent({Key? key, required this.toggleMenu})
      : super(key: key);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/imagebar.png'),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
